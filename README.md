...
Python Web Directory Scanner (pwds) — это многопоточный рекурсивный сканер веб-директорий на Python с визуализацией структуры веб-директории и автокалибровкой ложных ответов.
